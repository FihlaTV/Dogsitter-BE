...
from .serializers import UserProfileSerializer, UserStatusSerializer, FeedbackSerializer
...
class UserProfileAuthView(APIView):
    ...
    def post(self, request):
        ...
        if not email or not password:
            noentry = {
                'status': '0',
                'message': 'Login Failed. Kindly enter valid Username/Password.'
            }
            return JsonResponse(noentry)
